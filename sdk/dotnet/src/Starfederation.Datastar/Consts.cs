namespace Starfederation.Datastar
{
    ...
    public static class Consts
    {
        ...
        public static class EventType
        {
            ...
            public static string ToString(Datastar.EventType eventType)
            {
                return eventType switch
                {
                    Datastar.EventType.MergeFragments  => "datastar-merge-fragments",
                    Datastar.EventType.ExecuteScript   => "datastar-execute-script",
                    Datastar.EventType.MergeSignals    => "datastar-merge-signals",
                    Datastar.EventType.RemoveFragments => "datastar-remove-fragments",
                    Datastar.EventType.RemoveSignals   => "datastar-remove-signals",
