...
var Context = class {
  ...
  html = (html2, arg, headers) => {
    ...
    if (typeof html2 === "object") {
      return resolveCallback(html2, HtmlEscapedCallbackPhase.Stringify, false, {}).then((html3) => {
...
// https://jsr.io/@hono/hono/4.6.19/src/helper/html/index.ts
...
// shared-router.ts
var mergeFragment = (stream, fragment, options) => {
  let content;
...
var progressTemplate = (progress, itemCount) => html`
    ...
    return c.html(html(_a || (_a = __template(['\n      <html><head>\n      <script type="module" src="https://cdn.jsdelivr.net/gh/starfederation/datastar@1.0.0-beta.2/bundles/datastar.js"><\/script>\n      <link rel="stylesheet" href="/styles.css">\n      </head><body>\n      \n      <div\n        class="offlineNotice"\n        data-signals="{offlineSig:false}"\n        data-show="$offlineSig"\n        data-on-offline__window="$offlineSig=true"\n        data-on-online__window="$offlineSig=false"\n      >\u26A0\uFE0F You are offline - using service worker</div>\n    \n      ', `
      ...
      <script>
          if ('serviceWorker' in navigator) {
              navigator.serviceWorker.register('`, "')\n                  .then(registration => console.log('Service Worker registered:', registration.scope))\n                  .catch(error => console.log('Service Worker registration failed:', error));\n          }\n      <\/script>\n      </body></html>\n  "])), progressTemplate(0, 0), swPath));
  });
  const itemTemplate = (index) => html`
  <div class="item">
