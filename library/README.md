...
Getting started is as easy as adding a single 11.6 KiB script tag to your HTML.
...
{
    "imports": {
      "datastar": "https://cdn.jsdelivr.net/gh/starfederation/datastar@v1.0.0-RC.12/bundles/datastar.js"
    }
}
</script>
<script type="module">
