...
- Added hover information for signals.
- Added find references and rename for signals.
- Pro attributes and actions are now marked in completion and hover documentation.
